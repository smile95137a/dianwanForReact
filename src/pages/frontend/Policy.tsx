    ...
    <div className="policy">
      <div className="policy__item">
        <p className="policy__text">
          歡迎您使用電玩賞網站，
          電玩賞網站（XXXX；以下稱｢本網站｣）是由電玩賞娛樂有限公司（以下稱本公司）所經營之電子商務網站，並依據本網站使用條款及其他相關規範或公告提供您相關服務。您第一次消費前，請詳細閱讀並同意本網站使用條款後，再填寫基本資料加入會員。當您完成前述流程，即表示您已經閱讀、瞭解且同意本網站使用條款之全部內容與約定，如不同意本網站使用條款之全部或部分者，請勿填寫基本資料註冊本網站會員。
        </p>
      </div>
      <div className="policy__item">
        <p className="policy__text">
      ...
      <div className="policy__item">
        <div className="policy__item-title">
          <p className="policy__text">帳號、密碼</p>
        </div>
      ...
      <div className="policy__item">
        <div className="policy__item-title">
          <p className="policy__text">個人資料保護</p>
        </div>
        <div className="policy__item-main">
          <p className="policy__text">
          ...
          <p className="policy__text">為維護本網站的正常運作；</p>
          <p className="policy__text">
      ...
      <div className="policy__item">
        <div className="policy__item-title">
          <p className="policy__text">儲值代幣說明</p>
        </div>
        <div className="policy__item-main">
          <p className="policy__text">
            1.電玩賞會員所儲值的代幣等同於「現金禮券」，以下簡稱「代幣」。會員可以在電玩賞平台上消費任何商品。
          </p>
          <p className="policy__text">
      ...
      <div className="policy__item">
        <div className="policy__item-title">
          <p className="policy__text">交易注意事項</p>
        </div>
        <div className="policy__item-main">
          <p className="policy__text">
      ...
      <div className="policy__item">
        <div className="policy__item-title">
          <p className="policy__text">智慧財產權</p>
        </div>
        <div className="policy__item-main">
          <p className="policy__text">
      ...
      <div className="policy__item">
        <div className="policy__item-title">
          <p className="policy__text">服務終止及免責聲明</p>
        </div>
        <div className="policy__item-main">
          <p className="policy__text">
      ...
      <div className="policy__item">
        <div className="policy__item-title">
          <p className="policy__text">違約處理</p>
        </div>
        <div className="policy__item-main">
          <p className="policy__text">
          ...
          <p className="policy__text">提供錯誤或不實資料進行登錄；</p>
          ...
          <p className="policy__text">經本公司認定有惡意解約退貨之情事；</p>

          <p className="policy__text">對本公司客服部門有騷擾或不當言行；</p>
          <p className="policy__text">其他違反本網站服務條款或違法之情事。</p>
        </div>
      </div>
      <div className="policy__item">
        <div className="policy__item-title">
          <p className="policy__text">本條款之效力、解釋、問題諮詢、準據法</p>
        </div>
        <div className="policy__item-main">
          <p className="policy__text">
